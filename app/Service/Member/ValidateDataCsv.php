...
class ValidateDataCsv
{
    private $_ruleList = [
        'member_login_name' => [
            ['Require' => []], ['MaxLength' => ['45']], ['FormatCode' => []], ['DuplicateLoginName' => []]
        ],
        'member_password' => [
    ...
    private $_rules = [
        ...
        'DuplicateLoginName' => '%s行目%s列目のユーザーIDが重複しています。',
    ...
    **/
    ...
    public function checkDuplicateLoginName($data, &$errorPosition, $field)
    {
